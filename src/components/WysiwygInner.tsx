...
export const WysiwygInner: React.FC<WysiwygInnerProps> = ({
  ...
  return (
    <div
      className={clsx(
        // headings
        "[&_h2]:text-slate-950 [&_h2]:font-family-montserrat [&_h2]:font-bold [&_h2]:text-2xl [&_h2]:lg:text-5xl [&_h2]:leading-snug [&_h2]:mb-6",
        "[&_h3]:text-slate-950 [&_h3]:font-family-montserrat [&_h3]:font-bold [&_h3]:text-xl [&_h3]:lg:text-3xl [&_h3]:leading-snug [&_h3]:mt-6",

        // paragraphs + inline
        "[&_p]:text-slate-600 [&_p]:font-family-baskervville [&_p]:font-normal [&_p]:text-lg/7 [&_p]:pb-6 [&_p]:pt-6",
        "[&_p>a]:text-secondary [&_p>a]:underline",
        ...
        "[&_ul>li::before]:content-[''] [&_ul>li::before]:absolute [&_ul>li::before]:left-0 [&_ul>li::before]:top-[0.4rem] [&_ul>li::before]:w-[18px] [&_ul>li::before]:h-[18px]",
        ...
        // blockquote
        "[&_blockquote]:text-lg/7 [&_blockquote]:font-family-baskervville [&_blockquote]:text-slate-600 [&_blockquote]:font-normal [&_blockquote]:border-brand-2-50 [&_blockquote]:border-l-4 [&_blockquote]:lg:pl-8 [&_blockquote]:py-3",
        "[&_blockquote>p]:py-0",
