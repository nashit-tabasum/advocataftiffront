...
export default function SecondaryButton({ children }: Props) {
  ...
  return (
    <button
      className={`${baseBtn} bg-brand-2-100 text-brand-2-800 rounded-md shadow-sm hover:bg-brand-1-200 focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-indigo-500`}
    >
      {children}
    </button>
  );
