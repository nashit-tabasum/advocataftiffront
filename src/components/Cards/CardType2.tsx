  ...
  return (
    <div className="my-20">
      <a href="#" className="group">
        <div className="relative flex flex-col h-full overflow-hidden transition-all duration-500 ease-in-out cursor-pointer rounded-lg border border-slate-400 text-slate-50 bg-brand-1-900 hover:border-slate-200 hover:shadow-lg hover:-translate-y-1.5 focus-within:border-brand-1-900 focus-within:shadow-lg">
